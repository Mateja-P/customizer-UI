...
export default function Home() {
  ...
  const testemonialText = [
    {
      id: 0,
      from: 'Person 1',
      active: true,
      text: 'So how did the classical Latin become so incoherent? According to McClintock, a 15th century typesetter likely scrambled part of Ciceros De Finibus in order to provide placeholder text to mockup various fonts for a type specimen book.',
    },
    {
      id: 1,
      from: 'Person 2',
          ...
          <div className='flex-1'>
            <div className='w-[650px] 2xl:w-[600px] lg:w-[500px] sm:w-full'>
              ...
              <div className='flex justify-end'>
                <div>
                  <p className='w-[330px] text-[14px] lg:text-[13px]'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua.
                  </p>
                  <div className='mt-10 mb-6'>
                    <Button text='Izaberi Proizvod' bck='bg-[#EAE6DB]' />
                  </div>
                  <p className='montserrat capitalize text-red-500 font-[600] text-[14px]'>
                    popust na prvu porudbinu
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className='relative my-[200px] after:absolute after:right-0 after:top-0 after:w-1/2 after:h-full after:bg-primary lg:after:hidden lg:my-[90px] md:my-[0px]'>
        <div className='w1 flex py-[200px] gap-10 md:flex-col sm:py-[100px]'>
          <div className='flex-1'>
            ...
            <Button text='Pronadji Svoj Prvi Proizvod' bck='bg-[#fff]' />
          </div>
        ...
        <div className='w1'>
          <div className='flex justify-between md:flex-col mb-14'>
            <h2 className='montserrat text-[23px] montserrat font-[900] lg:text-[18px] sm:text-[17px]'>
              Samo neki od najprodavanijih proizvoda
            </h2>
            <Link
      ...
      <div className='bg-primary pt-28 pb-48 relative'>
        ...
        <div className='w1'>
          <h2 className='text-center montserrat font-[900] text-[23px] mb-5 md:text-[20px]'>
            Some of our users decided to share <br /> their experiences
          </h2>
          <div>
